...
int input_shooting(struct file_content * pfc,
  ...
  char * const unknown_namestrings[] = {"h",                        /* unknown param for target '100*theta_s' */
                                        ...
                                        "h",                        /* unknown param for target 'r_d*h' */
  ...
  enum computation_stage target_cs[] = {cs_thermodynamics, /* computation stage for target '100*theta_s' */
                                        ...
                                        cs_thermodynamics, /* computation stage for target 'r_d*h' */
...
int input_get_guess(double *xguess,
  ...
  for (index_guess=0; index_guess < pfzw->target_size; index_guess++) {
    ...
    case theta_MC:
      ...
      break;
    case rd_h:
      xguess[index_guess] = pfzw->target_value[index_guess]/147.02;
      dxdy[index_guess] = 1./147.02;
      /** Update pb to reflect guess */
      ba.h = xguess[index_guess];
      ba.H0 = ba.h *  1.e5 / _c_;
      break;
...
int input_try_unknown_parameters(double * unknown_parameter,
  ...
  /** Special case of theta_star_noreio (turn off reionisation) */
  for (i=0; i < unknown_parameters_size; i++) {
    if (pfzw->target_name[i] == theta_star_noreio) {
      th.reio_parametrization = reio_none;
    }
  }
  ...
  for (i=0; i < pfzw->target_size; i++) {
    ...
    case theta_MC:
      ...
      break;
    case rd_h:
      output[i] = th.rs_d*ba.h-pfzw->target_value[i];
      break;
    case Omega_dcdmdr:
...
int input_read_parameters_general(struct file_content * pfc,
  ...
  /** 8) Reionization parametrization */
    ...
    class_read_double("reio_zmin_calc_tau",pth->reio_zmin_calc_tau);
  ...
  case reio_many_tanh:
    ...
    class_read_int("many_tanh_xe_scheme",pth->many_tanh_xe_scheme);
    break;
  ...
  case reio_flexknot:
    ...
    class_read_int("reio_flexknot_xe_scheme",pth->reio_flexknot_xe_scheme);
    break;
...
int input_default_params(struct background *pba,
  ...
  pth->reio_asymm_add_HeII_tanh = 0;
